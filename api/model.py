...
def get_lm(model):
    ...
    if model == "gpt5-chat":
        ...
        lm = DarkLLM(model='openrouter/z-ai/glm-4.5', temperature=0.8, max_tokens=8192, api_key=os.getenv('OPENROUTER_API_KEY'), base_url='https://openrouter.ai/api/v1', extra_body=_get_provider(["z-ai", "parasail"]))
    elif model == "glm-46" or model == "glm":
        lm = DarkLLM(model='openrouter/z-ai/glm-4.5', temperature=0.8, max_tokens=8192, api_key=os.getenv('OPENROUTER_API_KEY'), base_url='https://openrouter.ai/api/v1', extra_body=_get_provider(["z-ai", "parasail"]))
    elif model == "glm-47":
        ...
        lm = DarkLLM(model='openrouter/anthropic/claude-opus-4.1', thinking_budget=0, temperature=0.9, max_tokens=8192, api_key=os.getenv('OPENROUTER_API_KEY'), base_url='https://openrouter.ai/api/v1', extra_body=_get_provider(["anthropic"]))
    elif model == "sonnet":
        lm = DarkLLM(model='openrouter/anthropic/claude-3.7-sonnet', thinking_budget=0, temperature=0.75, max_tokens=8192, api_key=os.getenv('OPENROUTER_API_KEY'), base_url='https://openrouter.ai/api/v1', extra_body=_get_provider(["anthropic"]))
    elif model == "sonnet-latest":
        lm = DarkLLM(model='openrouter/anthropic/claude-sonnet-4', thinking_budget=0, temperature=0.8, max_tokens=8192, api_key=os.getenv('OPENROUTER_API_KEY'), base_url='https://openrouter.ai/api/v1', extra_body=_get_provider(["anthropic"]))
    elif model == "grok-4":
        ...
        lm = DarkLLM(model='openrouter/google/gemini-2.5-pro', temperature=1.0, thinking_budget=0, max_tokens=8192, api_key=os.getenv('OPENROUTER_API_KEY'), base_url='https://openrouter.ai/api/v1', extra_body=_get_provider(["google", "google-vertex/global", "google-vertex/us"]), nosys=True, stream=False, **gemini_safety_settings)
    elif model == "soji":
        lm = DarkLLM(model='openrouter/soji', temperature=0.75, top_p=0.99, top_k=75, max_tokens=8192, api_key=os.getenv('CHUB_API_KEY'), base_url='https://inference.chub.ai/soji/v1')
    elif model == "kimi-k2":
        ...
        lm = DarkLLM(model='openrouter/nousresearch/hermes-4-405b', temperature=0.6, max_tokens=8192, api_key=os.getenv('OPENROUTER_API_KEY'), base_url='https://openrouter.ai/api/v1', extra_body=_get_provider(['nebius']))
    elif model == "r1":
        lm = DarkLLM(model='openrouter/deepseek/deepseek-r1-0528', model_name=model, temperature=0.6, max_tokens=8192, api_key=os.getenv('OPENROUTER_API_KEY'), base_url='https://openrouter.ai/api/v1', extra_body=_get_provider(["GMICloud", "Novita", "Parasail"]))
    elif model == "r1-classic":
        lm = DarkLLM(model='openrouter/deepseek/deepseek-r1', model_name=model, temperature=0.6, max_tokens=8192, api_key=os.getenv('OPENROUTER_API_KEY'), base_url='https://openrouter.ai/api/v1', extra_body=_get_provider(["fireworks"]))
    elif model == "rocinante":
        lm = DarkLLM(model='openrouter/thedrummer/rocinante-12b', temperature=0.9, max_tokens=4096, api_key=os.getenv('OPENROUTER_API_KEY'), base_url='https://openrouter.ai/api/v1', extra_body=_get_provider(["parasail", "infermatic"]))
    elif model == "mistral-medium":
        lm = DarkLLM(model='openrouter/mistralai/mistral-medium-3.1', temperature=0.9, max_tokens=8192, api_key=os.getenv('OPENROUTER_API_KEY'), base_url='https://openrouter.ai/api/v1', extra_body=_get_provider(["mistral"]))
    elif model == "sonoma-sky":
        lm = DarkLLM(model='openrouter/openrouter/sonoma-sky-alpha', temperature=0.7, max_tokens=8192, api_key=os.getenv('OPENROUTER_API_KEY'), base_url='https://openrouter.ai/api/v1', extra_body=_get_provider(["stealth"], stealth_mode=True))
